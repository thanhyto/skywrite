...
async function loadData(dataType) {
  dataFilePath = "";
  if (dataType === "anchor") {
    dataFilePath = "data/scaled/scaledheartshape.jsonl";


  } else if (dataType === "nearestneighbor") {
    dataFilePath = "data/NearestNeighbor/NearestNeighborEmbeddings.jsonl";
...
addButtonsDataEvent("nearestneighbor");
